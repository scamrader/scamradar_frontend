...
const Signup = () => {
    return(
        <main className="w-full lg:bg-[#F6F8F0] min-h-[100vh] py-[40px]">
            ...
            <section className="mt-[24px] bg-[#fff] rounded-[24px] p-[16px] lg:p-[40px] max-w-[600px] mx-auto">
                ...
                <form className="mt-[40px] space-y-[24px] text-[#4C545F]">
                    <div className="flex flex-col lg:flex-row space-y-[24px] lg:space-y-0 lg:space-x-[24px] w-full">
                    ...
                    <div className="flex space-x-[10px] items-center">
                        ...
                        className=""
                    />
                    <p className="text-[14px] text-[#0D1117]">Creating an account means you agree with out <span className="text-[#017189]">
                        <Link href="/legal/privacy-policy" className="text-[#017189]">Terms of Service</Link>
                        </span>
                    </p>
                    </div>
                    ...
                    <div className="flex justify-between space-x-[12px] items-center">
                        <button className="cursor-pointer block w-[111px] lg:w-[165px] h-[60px] border border-[#E9EAEB] bg-[#fff] rounded-[10px] flex items-center justify-center">
